...
const CLOUDINARY_ILLUSTRATION_URLS: Record<number, string> = {
  1: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254987/portrait-01_ojiv22.svg",
  2: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254987/portrait-02_iezxeu.svg",
  3: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254988/portrait-03_vk40gv.svg",
  4: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254988/portrait-04_r5wd2i.svg",
  5: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254988/portrait-05_sxyoxj.svg",
  6: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254989/portrait-06_zvhw4b.svg",
  7: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254989/portrait-07_xkinn0.svg",
  8: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254989/portrait-08_ubbybp.svg",
  9: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254990/portrait-09_odqg05.svg",
  10: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254992/portrait-10_lfoj6t.svg",
  11: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254993/portrait-11_r7wthx.svg",
  12: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254993/portrait-12_epyv2z.svg",
  13: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254994/portrait-13_zieweh.svg",
  14: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254995/portrait-14_jdnkwj.svg",
  15: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254996/portrait-15_uea9mw.svg",
  16: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254997/portrait-16_xttrkf.svg",
  17: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254998/portrait-17_vuodvh.svg",
  18: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254998/portrait-18_n8b1ck.svg",
  19: "https://res.cloudinary.com/dmornfz49/image/upload/v1780254998/portrait-19_ezzcxy.svg",
  20: "https://res.cloudinary.com/dmornfz49/image/upload/v1780255000/portrait-20_lidtou.svg",
  21: "https://res.cloudinary.com/dmornfz49/image/upload/v1780255003/portrait-21_hwcqgw.svg",
  22: "https://res.cloudinary.com/dmornfz49/image/upload/v1780255004/portrait-22_exehxx.svg",
  23: "https://res.cloudinary.com/dmornfz49/image/upload/v1780255004/portrait-23_gcjmeh.svg",
  24: "https://res.cloudinary.com/dmornfz49/image/upload/v1780255005/portrait-24_pzrhi5.svg",
};
...
const ITEMS: IllustrationItem[] = Array.from({ length: 24 }, (_, index) => {
  const number = index + 1;
  const padded = String(number).padStart(2, "0");
  const id = `portrait-${padded}`;
  return {
    id,
    ...
    <>
      <section ref={sectionRef} className="gcp-carousel-section portraits-carousel-section" aria-label="Grieg Connect Portrait Illustrations">
        <style>{`
          ...
          .portraits-carousel-section::before {
            content: "";
            position: absolute;
            inset: 0;
            z-index: 0;
          ...
          .portraits-lightbox .lightbox-content {
          ...
          .portraits-lightbox .lightbox-stage {
            width: 100%;
            height: 100%;
            display: flex;
            align-items: center;
          ...
          .portraits-lightbox .lightbox-stage svg,
          .portraits-lightbox .lightbox-stage > * {
            width: 100%;
            height: 100%;
            max-width: 100vw;
          ...
          .portraits-lightbox .lightbox-hit {
            position: absolute;
            top: 0;
            bottom: 0;
            background: none;
          ...
          .portraits-lightbox .lightbox-hit:focus,
          .portraits-lightbox .lightbox-hit:focus-visible {
            outline: none;
          }

          .portraits-lightbox .lightbox-hit-left {
            left: 0;
            width: 25vw;
          ...
          .portraits-lightbox .lightbox-hit-center {
            left: 25vw;
            width: 50vw;
            justify-content: center;
          }

          .portraits-lightbox .lightbox-hit-right {
            right: 0;
            width: 25vw;
          ...
          .portraits-lightbox .lightbox-indicator {
            position: absolute;
            left: 50%;
          ...
          .portraits-lightbox.is-ui-idle .lightbox-indicator {
            opacity: 0.34;
          }

          .portraits-lightbox .lightbox-indicator-label,
          .portraits-lightbox .lightbox-indicator-separator,
          .portraits-lightbox .lightbox-indicator-glyph,
          .portraits-lightbox .lightbox-indicator-bar {
          ...
          .portraits-lightbox .lightbox-indicator-number {
            font-size: 0.82em;
          }
          ...
          .portraits-lightbox .lightbox-indicator-bar-notch {
            display: inline-block;
            opacity: 0.72;
            transition: opacity 300ms cubic-bezier(0.16, 1, 0.3, 1);
          }

          .portraits-lightbox .lightbox-indicator-bar-notch.is-unwatched {
            opacity: 0.54;
          }
          ...
          .portraits-lightbox .lightbox-hit-arrow {
            width: 32px;
            height: 56px;
            opacity: 0.35;
            transform: scale(1);
          ...
          .portraits-lightbox.is-ui-idle .lightbox-hit-arrow {
            opacity: 0;
            transform: scale(0.92);
            filter: drop-shadow(0 0 0 rgba(255, 255, 255, 0));
          }

          .portraits-lightbox.is-keyboard-input .lightbox-hit-arrow {
            opacity: 0;
            transform: scale(0.92);
            filter: drop-shadow(0 0 0 rgba(255, 255, 255, 0));
          }

          .portraits-lightbox .lightbox-hit-arrow svg {
            width: 100%;
            height: 100%;
            display: block;
          }

          .portraits-lightbox:not(.is-keyboard-input) .lightbox-hit:hover .lightbox-hit-arrow,
          .portraits-lightbox:not(.is-keyboard-input) .lightbox-hit:focus-visible .lightbox-hit-arrow {
            opacity: 1;
            transform: scale(1.06);
            filter: drop-shadow(0 0 12px rgba(255, 255, 255, 0.36));
          }

          .portraits-lightbox .lightbox-hit:active .lightbox-hit-arrow {
            transform: scale(0.95);
          }

          .portraits-lightbox:not(.is-keyboard-input) .lightbox-hit-left:hover .lightbox-hit-arrow,
          .portraits-lightbox:not(.is-keyboard-input) .lightbox-hit-left:focus-visible .lightbox-hit-arrow {
            transform: translateX(-3px) scale(1.06);
          }

          .portraits-lightbox:not(.is-keyboard-input) .lightbox-hit-right:hover .lightbox-hit-arrow,
          .portraits-lightbox:not(.is-keyboard-input) .lightbox-hit-right:focus-visible .lightbox-hit-arrow {
            transform: translateX(3px) scale(1.06);
          }
