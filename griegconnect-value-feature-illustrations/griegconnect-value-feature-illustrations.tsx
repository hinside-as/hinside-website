...
const CLOUDINARY_ILLUSTRATION_URLS: Record<number, string> = {
  ...
  34: "https://res.cloudinary.com/dmornfz49/image/upload/v1780164961/illustration-34_j7i9h5.svg",
...
function Lightbox({
  ...
  return (
    <div className={`lightbox-overlay ${isUiActive ? "" : "is-ui-idle"} ${isKeyboardInputActive ? "is-keyboard-input" : ""}`}>
      <button
        type="button"
